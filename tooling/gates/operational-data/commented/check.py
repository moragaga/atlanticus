...
CAPABILITIES: dict[str, OperationalDataCapability] = {
    ...
    # Meteodata incorpora un productor propio y no depende del productor PI.
    'producer-meteodata': OperationalDataCapability(
        'producer-meteodata',
        'atlanticus-data-producers-meteodata',
        'atlanticus.data_producers.meteodata',
        'producers/meteodata',
        'producers/meteodata/src',
        'producers/meteodata/commented',
    ),
    ...
    # Composición ejecutable autónoma para materializar las dos salidas Meteodata.
    'process-meteodata': OperationalDataCapability(
        'process-meteodata',
        'atlanticus-operational-data-meteodata-process',
        'atlanticus.operational_data.processes.meteodata',
        'processes/meteodata',
        'processes/meteodata/src',
        'processes/meteodata/commented',
    ),
...
EXPECTED_WORKSPACE_SOURCES = {
    ...
    'atlanticus-data-producers-meteodata': {'workspace': True},
    ...
    'atlanticus-operational-data-meteodata-process': {'workspace': True},
...
# Contrato de entrypoint y perfil de sistema de cada proceso desplegable.
PROCESS_CONTRACTS = {
    'process-pi': ('operational-data-pi', 'base'),
    'process-meteodata': ('operational-data-meteodata', 'base'),
