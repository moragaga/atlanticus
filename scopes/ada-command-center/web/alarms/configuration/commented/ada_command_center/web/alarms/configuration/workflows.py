...
# Coordina publicación y lectura sin mezclar metadata versionada con el documento editable.
class AlarmConfigurationManagerSourceWorkflow:
    ...
    def publish_draft(
        ...
        # La revisión Tools se fija exactamente en el save. No se redescubre después en Projection.
        ...
        # El snapshot transversal une el contenido validado con el Confirmed Tool Catalog vigente.
