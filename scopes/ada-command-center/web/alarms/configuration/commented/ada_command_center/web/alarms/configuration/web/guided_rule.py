# Las secciones del asistente muestran grupos de campos sin alterar el contrato del dominio.
...
# Separa pestañas y contenidos: no inserta operaciones destructivas en el formulario.
