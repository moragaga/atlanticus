# Este módulo normaliza el documento de edición y mantiene relaciones válidas con Tool.
...
# Deriva destinos únicos desde las Tools confirmadas del routing sin perder selecciones compatibles.
...
# Valida la selección de componentes y descarta subcomponentes desvinculados.
...
# Comprueba identidades compuestas contra el catálogo sin aceptar entradas manuales.
...
# La intención de desactivación se traduce al subcontrato completo sin alterar el scope.
