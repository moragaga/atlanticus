# Layout inicial estable en modo documental para Rules + Messages.
# El usuario puede editar/importar el contrato completo sin adelantar el editor visual final.
# Validar/publicar/proyectar sigue siendo responsabilidad del workflow genérico Manager.
