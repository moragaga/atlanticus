        ...
        [
            ...
            html.Section(
                [
                    ...
                    # El shell está fuera del contenido que Dash vuelve a pintar; así el scroll sobrevive.
                    html.Div(
                        [
                            html.Div(className='alarm-family__modal-backdrop'),
                            html.Div(
...
def build_structured_editors(
    ...
    # El documento editable mantiene el contrato Rules + Messages, sin familias persistentes.
...
# Enlaza la selección contextual con los editores actuales, sin duplicar sus formularios.
...
def _runtime_context(context: AlarmConfigurationAdminWebContext) -> object:
    # El contexto muestra procedencia, pero la publicación sigue en el shell genérico.
    return html.Section(
        [
            html.Div(
                [
