# Composición visual del editor de alarmas siguiendo los controles del Manager de Atlanticus.
...
# Monta una sola estructura de modal, los stores y el diálogo de eliminación.
