...
# Local y Blob son implementaciones alternativas del contrato SourceStore.
class AlarmConfigurationSourceProvider(StrEnum):
    LOCAL = 'local'
    BLOB = 'blob'


# Local y Cosmos son implementaciones alternativas del contrato ProjectionStore.
...
# La aplicación elige proveedores independientemente; no se inventa un namespace de ADA para Command Center.
