...
# El agregado conecta interfaces ya existentes y no introduce un workflow alternativo al Manager.
...
# La composición es perezosa: recibe clientes ya resueltos por la aplicación, incluidas conexiones nombradas.
...
# Las releases e History pertenecen a LocalSourceStore o BlobSourceStore genéricos.
def _compose_source(
    *,
    settings: AlarmConfigurationPersistenceSettings,
...
# El store operacional conserva un head de configuración publicado; no contiene historia ni recalcula Tools.
