...
def test_workspace_registers_alarm_runtime_member_and_sources() -> None:
    ...
    assert (
        'ada-command-center-alarms-runtime-process==1.0.0' in workspace['project']['dependencies']
    )
    ...
    assert (
        sources['atlanticus-operational-data-planner']['path'] == '../../operational-data/planner'
    )
