# Espejo comentado: Compone el commit del dominio con el registro durable de Persistence.
...
from ada_command_center.alarms.core import GroupCommitMaterialization
from ada_command_center.alarms.persistence import (
    EngineCommitMetadata,
    EngineCommitRecord,
    GroupRuntimeSnapshot,
)
from ada_command_center.processes.alarms_runtime.snapshot import encode_group_runtime_snapshot
