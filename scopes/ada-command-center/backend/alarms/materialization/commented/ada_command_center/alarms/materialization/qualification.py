# Espejo pedagógico de las qualification inputs mínimas consumidas por B.2.
# Tool reconciliation expone únicamente qué Tools están GREEN para resolver; no replica su taxonomía interna.
# Evaluator qualification expone keys aceptadas; no transporta callables, requirements ni Runtime registry.
