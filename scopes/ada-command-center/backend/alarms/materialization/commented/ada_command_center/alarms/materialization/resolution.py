# Espejo pedagógico del resultado atómico B.2.
# READY exige Runtime + Delivery con la misma AlarmResolutionKey y sin findings BLOCKING.
# BLOCKED exige al menos un BLOCKING y prohíbe artifacts parciales.
