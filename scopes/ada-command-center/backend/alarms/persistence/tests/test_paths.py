...
from ada_command_center.alarms.persistence import AlarmPersistencePaths
...
def test_paths_follow_operational_volume_contract(tmp_path: Path) -> None:
    ...
    assert paths.alarms_root == tmp_path / 'ada-command-center' / 'alarms'
    ...
    assert (
        ...
        == tmp_path
        / 'ada-command-center/alarms/runtime/journal/open/year=2026/month=08/day=23/hour=20/part-0000.jsonl'
    )
