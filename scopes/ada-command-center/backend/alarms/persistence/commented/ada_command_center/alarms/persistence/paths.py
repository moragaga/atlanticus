...
# Las rutas se resuelven bajo el namespace ada-command-center/alarms/runtime acordado y nunca inventan raíces alternativas.
...
from ada_command_center.alarms.persistence.models import parse_segment_id
...
class AlarmPersistencePaths:
    def __init__(self, *, shared_volume_path: str | Path) -> None:
        ...
        self._alarms_root = path / 'ada-command-center' / 'alarms'
