...
# Clase EvidenceContractRef: contrato tipado con invariantes explícitas para evitar estados ambiguos.
...
@dataclass(frozen=True, slots=True)
# Clase EvidenceRecord: contrato tipado con invariantes explícitas para evitar estados ambiguos.
...
@dataclass(frozen=True, slots=True)
# Clase EvidenceMaterialization: contrato tipado con invariantes explícitas para evitar estados ambiguos.
...
# Función materialize_evidence: transformación determinística; sus efectos externos se componen fuera del Core.
...
# Función _evidence_id: transformación determinística; sus efectos externos se componen fuera del Core.
...
# Función _json_value: transformación determinística; sus efectos externos se componen fuera del Core.
...
# Función _validate_sampling_interval: transformación determinística; sus efectos externos se componen fuera del Core.
