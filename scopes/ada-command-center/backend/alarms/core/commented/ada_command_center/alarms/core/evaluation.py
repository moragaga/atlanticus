# Espejo pedagógico de la frontera aislada entre evaluator y lifecycle.
# El evaluator recibe sólo EvaluationContext y no conoce Occurrence, Episode ni Delivery.
# Las excepciones inesperadas se convierten externamente en ERROR de esa alarma.
# Una salida faltante, inválida o con identidad/tiempo incorrectos nunca se interpreta como INACTIVE.
