...
def resolve_management_cascades(
    ...
    *,
    ...
    for source_identity, source_state in sorted(
        ...
        # Deactivation domina: conserva el scope aunque Management ya haya reaparecido o sido limpiado.
        ...
        # Sin Deactivation vigente, la suppression vuelve a depender del ManagementEffect.
