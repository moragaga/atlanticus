...
# Clase JourneyEvent: contrato tipado con invariantes explícitas para evitar estados ambiguos.
class JourneyEvent:
    event_id: str
    event_key: str
...
# Función materialize_journey: transformación determinística; sus efectos externos se componen fuera del Core.
...
# Función _priority_journey_events: transformación determinística; sus efectos externos se componen fuera del Core.
...
# Función _priority_transition_effective_at: transformación determinística; sus efectos externos se componen fuera del Core.
...
# Función _journey_event: transformación determinística; sus efectos externos se componen fuera del Core.
def _journey_event(
    *,
    event_key: str,
    effective_at: datetime,
