# Binding físico de Tool Catalog CURRENT sobre Atlanticus Storage.
# V1 mantiene un único blob reemplazable; no introduce history, releases ni LKG paralelo.
# Un blob ausente representa que todavía no existe un catálogo consolidado.
