# Contratos puros del snapshot consolidado.
# La topología no se redefine: se reutiliza ToolStructure del dominio Tool CURRENT.
# La revisión es determinística y excluye generated_at_utc para no cambiar por una mera relectura.
