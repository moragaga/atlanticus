...
# El store solo conoce un container_name inyectado; puede ser standalone o users-support por composición.
class CosmosAdaAccessProjectionStore(ProjectionStore[AdaAccessConfiguration]):
    ...
    def replace_active(
        ...
        # Se valida el documento realmente persistido antes de devolverlo al ProjectionService.
...
def _cosmos_item_id(source_key: SourceKey) -> str:
    # El prefijo mantiene namespace propio cuando el container físico se comparte con otras projections.
