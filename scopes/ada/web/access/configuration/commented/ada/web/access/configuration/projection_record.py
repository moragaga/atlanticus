...
# Este contrato durable pertenece a ADA Access y conserva la provenance exacta de la Projection.
...
def ada_access_projection_to_document(
    ...
    *,
    ...
    # Dependencies se persisten como parte del target materializado; nunca se reconstruyen desde CURRENT.
...
# El target se serializa recursivamente porque cada dependency puede tener su propia provenance upstream.
