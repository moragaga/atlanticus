...
# La Projection de Access materializa el mismo contrato compacto de grants que luego consume runtime.
# Su validez depende de una Projection concreta de Profiles, no de una lectura independiente del Source.
class AdaAccessProjectionBuilder(ProjectionBuilder[AdaAccessConfiguration]):
    ...
    def build(
        ...
        *,
        ...
        # Se exige el target exacto seleccionado para evitar mezclar revisiones.
...
def create_ada_access_projection_service(
    *,
    ...
    # El target actual de Access captura la Projection exacta de Profiles como dependencia.
