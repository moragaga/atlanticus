...
# ADA Access posee sólo la relación profile_key -> access_keys.
...
class AdaAccessConfiguration:
    ...
    # Users/composición entregan la profile_key; Access sólo resuelve los permisos ADA garantizados.
    def resolve(
        self,
        profile_key: str,
        *,
    ...
    def from_document(cls, document: dict[str, Any]) -> AdaAccessConfiguration:
        try:
            # El contrato legacy user_id -> profile_keys se rechaza explícitamente.
