# La UI se divide en catálogo de accesos y asignación de accesos a Profiles proyectados.
# Los Profiles se leen desde la Projection inyectada; la UI no mantiene un catálogo paralelo.
...
def render_profile_assignments(
    ...
    return [
        _profile_assignment_row(configuration, profile)
