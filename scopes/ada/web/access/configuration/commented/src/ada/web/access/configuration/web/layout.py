# La UI conserva el layout paginado común y mantiene filas de perfiles de altura estable.
# Configurar se deshabilita cuando no existen accesos, por lo que nunca se abre un modal vacío.
# El modal usa dbc.Checkbox para reutilizar el contrato Bootstrap sin clases visuales de Dash.
