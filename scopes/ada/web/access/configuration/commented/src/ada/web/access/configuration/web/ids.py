# IDs estables usados por layout y callbacks de la superficie administrativa.
# Los IDs dinámicos conservan la access_key o profile_key como identidad funcional.
