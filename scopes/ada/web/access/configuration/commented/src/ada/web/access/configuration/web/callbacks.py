# Los callbacks editan un borrador en memoria y delegan persistencia al workspace de Manager.
# Publicación y Projection siguen perteneciendo al workflow genérico de Manager.
# Toda mutación administrativa vuelve a validar el contrato de dominio.
