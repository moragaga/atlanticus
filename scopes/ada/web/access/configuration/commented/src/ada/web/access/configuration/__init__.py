# Este módulo expone el contrato público de configuración de ADA Access.
# El catálogo de access_keys y las asignaciones por Profile comparten un único Source/Projection.
