...
from ada.web.runtime_experience import ADA_WAKE_LOCK_ASSET_LAYER, create_ada_wake_lock_module


def test_wake_lock_module_has_independent_extracted_asset_layer() -> None:
