...
# Contrato neutral recibido por los consumidores de salud temporal.
...
# CS-003 permanece como tabla de verdad pura, sin thresholds ni timestamps.
...
def resolve_content_state_from_freshness(
    *conditions: SourceFreshnessCondition,
    ...
    # La agregación reutiliza la precedencia única de Content State.
