...
# IDs propios de la inspección read-only de Tools.
...
# Construye una vista tolerante a estados parciales sin inventar un contrato válido.
...
# Los pattern IDs de Dash se indexan explícitamente para no depender del orden visual.
