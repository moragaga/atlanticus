...
# Tools replica el patrón visual de Users y Navigation con un asset propio, sin depender de sus clases privadas.
...
# Envuelve el editor ya validado entre el contexto de importación y el guardado del borrador.
...
# El contexto superior reutiliza Fuente de verdad, Proyección e Importar como Users y Navigation.
