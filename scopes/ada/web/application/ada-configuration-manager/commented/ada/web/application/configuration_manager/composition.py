...
# Estas tres keys son el camino productivo schema 2 para validate/read/publish.
...
def build_configuration_manager_surface(
    ...
    # Tools recibe los nombres de Source y Projection desde Dependencies igual que Users y Navigation.
    ...
    return ManagerSurfaceDefinition(
        ...
        modules=(
            ManagerModule(
                ...
                # Users no declara lifecycle legacy: status/history/projection quedan fuera hasta su cutover exacto.
            ...
            ManagerModule(
                ...
                # La superficie Tools recibe su contexto para reutilizar el patrón visual ya establecido.
...
def _register_services(
    ...
    # El subject_id es el actor estable usado tanto por validación como por publicación exacta.
