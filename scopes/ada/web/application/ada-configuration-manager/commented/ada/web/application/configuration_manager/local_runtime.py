...
# El runtime local compone dependencias reales del entorno de desarrollo.
# La descripción visible de Perfiles pertenece a la composición ADA y no cambia el default genérico.
