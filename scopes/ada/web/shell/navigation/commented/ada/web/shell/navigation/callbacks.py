...
def register_ada_navigation_callbacks(app: Dash, _services: ServiceRegistry) -> None:
    # Controller y Location permanecen montados fuera del panel. La hidratación
    # registra la ruta sin abrir ni cerrar; el primer clic efectivo abre el panel.
    # La navegación sólo cierra el panel si el pathname cambió realmente.
    ...
    # La expansión manual sigue siendo independiente por grupo. La ruta activa sólo fuerza abierto
    # su grupo padre y mueve el marcador visual sin cerrar otros accordions que el usuario haya abierto.
    app.clientside_callback(
        """
        function(
            _groupClicks,
