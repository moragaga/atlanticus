# Espejo comentado de presentación estructural R2.
...
# Cada Component aparece resumido y despliega su editor sólo cuando se abre.
...
# La eliminación queda separada de Visible también en para evitar ambigüedad.
