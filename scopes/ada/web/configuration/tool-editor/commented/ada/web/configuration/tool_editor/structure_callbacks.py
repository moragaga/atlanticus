...
def register_tool_structure_editor_callbacks(app: object) -> None:
    ...
    # Process hereda la cobertura general y bloquea el selector; Integrated parte limpio.
    def update_context_fields(
        ...
        if process:
            ...
            # Sólo una transición real desde Process elimina valores heredados; la edición normal conserva lo elegido.
            scopes = (
    ...
    # Visible también en sólo habilita componentes del mismo ámbito del propietario.
