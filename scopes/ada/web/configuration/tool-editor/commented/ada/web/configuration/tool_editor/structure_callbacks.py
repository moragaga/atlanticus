# Espejo comentado de callbacks de estructura anidada.
...
# Registra edición anidada sin alterar el dominio.
...
# Agrega dentro del Component que originó la acción.
...
# Refresca sólo destinos compatibles.
...
# Reconstruye owner_component_key desde owner_index.
