...
class KpiDefinitionValidationResult:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.valid, bool):
            raise KpiDefinitionValidationError('KPI definition validation flag must be boolean')
...
class KpiDefinitionPublicationResult:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.published, bool):
            raise KpiDefinitionValidationError('KPI definition publication flag must be boolean')
        object.__setattr__(
            self,
            'kpi_configuration_revision',
            _required_text(
...
class KpiDefinitionProjectionResult:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.projected, bool):
            raise KpiDefinitionValidationError('KPI definition projected flag must be boolean')
        object.__setattr__(self, 'issues', tuple(self.issues))
        object.__setattr__(self, 'summary', tuple(self.summary))
