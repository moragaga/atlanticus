...
# Contrato durable que luego podrá almacenar un adapter Cosmos sin que este módulo conozca Azure.
...
# La revisión proyectada representa una publicación concreta de una revisión de source.
