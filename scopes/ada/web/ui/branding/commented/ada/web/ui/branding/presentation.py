...
def build_operational_brand(state: OperationalBrandState) -> html.Div:
    # La bajada configurada sólo se agrega cuando existe un contexto real. El bootstrap no
    # inventa una Tool para rellenar visualmente una línea que todavía no tiene fuente.
    lockup_children = [
        html.Div(
