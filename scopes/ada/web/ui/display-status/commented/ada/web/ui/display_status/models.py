# Contrato compartido para representar valores normales o degradados de manera consistente en ADA Web.
...
from .module import ADA_DISPLAY_STATUS_ASSET_LAYER
...
class DisplayValue:
    ...
    def __post_init__(self) -> None:
        # Un valor OK siempre expone payload; un estado degradado nunca filtra un valor potencialmente inválido.
...
class StatusVisual:
    ...
    def asset_url(self) -> str:
        return f'/assets/{ADA_DISPLAY_STATUS_ASSET_LAYER.target_name}/img/status/{self.asset_name}'
...
def resolve_status_visual(status: DisplayStatus) -> StatusVisual | None:
    # OK no necesita icono; sólo los estados degradados tienen representación visual común.
