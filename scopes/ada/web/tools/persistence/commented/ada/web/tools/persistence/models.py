# Define únicamente selección de providers y estado de resolución.
# No contiene credenciales, clientes SDK ni acceso a red.
...
class ToolPersistenceSettings:
    ...
    def __post_init__(self) -> None:
        ...
        # Source local y Projection local pueden compartir el mismo root base.
        if (
