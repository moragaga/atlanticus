...
# El Source durable usa el contrato genérico Atlanticus y un único recurso lógico comprimido.
...
# Payload semántico que queda dentro de cada release durable de Tool.
...
# Codec responsable de serializar y recuperar la configuración sin asumir el backend físico.
...
# Fachada ADA sobre SourceStore; CAS se expresa con ConcurrencyToken, no con revisions privadas.
...
# Decodificación defensiva con límites explícitos antes de materializar JSON.
