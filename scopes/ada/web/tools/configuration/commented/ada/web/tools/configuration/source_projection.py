...
# Builder semántico: transforma un release genérico en la configuración operacional proyectada.
...
# La mecánica de estado, target y persistencia activa queda delegada a SourceProjectionService.
