...
from ada.web.kpis.registry.configuration.web.ids import (
    ACTIVE_FILTERS_ID,
    ADD_BUTTON_ID,
    AVAILABILITY_ID,
    DATA_MODE_FILTER_ID,
...
def build_kpi_configuration_editor(
    page: Page[KpiRegistryBinding],
    *,
    destination_catalog: KpiDestinationCatalog,
    query: KpiRegistryQuery | None = None,
    ...
    resolved_query = query or KpiRegistryQuery(page=page.request)
...
def build_kpi_configuration_active_filters(
    ...
    *,
    ...
    if query.data_mode is not KpiRegistryDataMode.ALL:
    ...
    *,
    ...
    if not page.items:
        filtered = bool(
            ...
            or resolved_query.data_mode is not KpiRegistryDataMode.ALL
        )
        if filtered:
...
def build_kpi_configuration_editor_modal(
    *,
    destination_catalog: KpiDestinationCatalog,
    binding: KpiRegistryBinding | None = None,
    is_open: bool = False,
) -> Component:
                            ...
                            options=[
                                {
                                    ...
                                    'value': KpiRegistryDataMode.ALL.value,
                                },
                                {
                                    'label': 'Sólo último',
                                    'value': KpiRegistryDataMode.LATEST.value,
                                },
                                {
                                    'label': 'Sólo serie temporal',
                                    'value': KpiRegistryDataMode.TIMESERIES.value,
                                },
                                {
                                    'label': 'Último + serie temporal',
                                    'value': (
                                        KpiRegistryDataMode.LATEST_AND_TIMESERIES.value
                                    ),
                                },
                            ],
...
def _data_mode_label(mode: KpiRegistryDataMode) -> str:
    return {
        KpiRegistryDataMode.ALL: 'Todos los modos',
        KpiRegistryDataMode.LATEST: 'Sólo último',
        KpiRegistryDataMode.TIMESERIES: 'Sólo serie temporal',
        KpiRegistryDataMode.LATEST_AND_TIMESERIES: 'Último + serie temporal',
    }[mode]
