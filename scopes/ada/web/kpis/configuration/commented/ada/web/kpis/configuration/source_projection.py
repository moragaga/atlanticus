# La Projection de KPI depende del ProjectionTarget exacto de Tools.
# El builder vuelve a leer el snapshot para detectar carreras antes de validar y persistir el payload.
