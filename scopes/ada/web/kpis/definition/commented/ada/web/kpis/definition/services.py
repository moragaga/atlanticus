...
# Valida huérfanos como error, faltantes como warning y revalida autoridad antes de mutaciones.
from dataclasses import dataclass
from datetime import UTC, datetime

from ada.web.kpis.definition.authority import KpiDefinitionAuthorityCatalog
...
from ada.web.kpis.definition.projection import KpiDefinitionProjection
    ...
    def load_revision_configuration(
        ...
        if document is None:
            raise KpiDefinitionSourceError(
                'KPI definition revision does not exist'
            )
    ...
    def validate_configuration(
        ...
        return KpiDefinitionValidationResult(
            ...
            kpi_configuration_revision=(
                authority.kpi_configuration_revision
    ...
    def publish_configuration(
        ...
        *,
        ...
        self._require_authority(
            expected_revision=authority.kpi_configuration_revision
        )
    ...
    def _require_authority(
        ...
        *,
        ...
        if authority is None:
            raise KpiDefinitionValidationError(
                'KPI configuration authority is not available'
            )
        if (
...
class KpiDefinitionProjectionWorkflow:
    ...
    def get_status(self) -> KpiDefinitionStatus:
        ...
        return KpiDefinitionStatus(
            ...
            active_kpi_configuration_revision=(
                active.kpi_configuration_revision
    ...
    def project(
        ...
        if (
            ...
            and active.kpi_configuration_revision
            == authority.kpi_configuration_revision
        ):
    ...
    def _require_source(
        ...
        if document is None:
            raise KpiDefinitionSourceError(
                'KPI definition source does not exist'
            )
...
def _require_configuration(
    ...
    if not isinstance(configuration, KpiDefinitionConfiguration):
        raise KpiDefinitionValidationError(
            'KPI definition configuration is invalid'
        )
...
def _validate_configuration(
    ...
    defined = {
        definition.kpi_key: index
        for index, definition in enumerate(configuration.definitions)
    }
        ...
        if kpi_key not in authority.keys:
            issues.append(
                KpiDefinitionIssue(
                    ...
                    message=(
                        f'KPI definition {kpi_key!r} does not exist '
