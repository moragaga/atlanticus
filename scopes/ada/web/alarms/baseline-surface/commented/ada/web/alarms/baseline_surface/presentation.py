...
# Construye únicamente la geometría neutral del baseline a partir de la proyección estructural.
...
# Expone las identidades contractuales necesarias para alinear el punto con la UI futura.
