# Configuración mínima del proceso: aplicación upstream y cadencia de polling.
...
def _required_text(value: str, field_name: str) -> str:
    ...
    if value != value.strip():
        raise KpiHistorianConfigurationError(f'{field_name} must not contain surrounding whitespace')
    return value
