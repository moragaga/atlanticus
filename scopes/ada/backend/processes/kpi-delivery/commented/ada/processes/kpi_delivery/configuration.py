# Lee y valida una fotografía de KPI Configuration al iniciar.
...
# Lee exactamente el documento administrativo configurado.
...
# Mantiene aislada la responsabilidad de _configuration_from_document.
...
# Mantiene aislada la responsabilidad de _binding_from_payload.
...
# Mantiene aislada la responsabilidad de _required_bool.
...
# Mantiene aislada la responsabilidad de _optional_text.
