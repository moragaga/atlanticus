...
# Traduce estrictamente el KPI Registry durable a la configuración interna de Timeseries Delivery.
# El proceso replica intencionalmente el contrato de frontera.
# Así conserva independencia operacional respecto de otros procesos.
