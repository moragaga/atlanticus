...
# Versión del documento de autoridad durable del Historian.
HISTORIAN_AUTHORITY_SCHEMA_VERSION = 1
# Identidad lógica compartida por el productor Historian y sus consumidores.
...
class KpiHistorianAuthority:
    # Watermark hasta el cual History quedó materializado de forma durable.
    watermark_utc: datetime

    def __post_init__(self) -> None:
        # Reutiliza el contrato canónico de UTC y precisión de segundos.
    ...
    def revision(self) -> str:
        # La revisión deriva del schema de History y del watermark confirmado.
        return historian_revision(watermark_utc=self.watermark_utc)

    def to_payload(self) -> dict[str, Any]:
        # Persiste tanto la autoridad temporal como su revisión verificable.
        return {
    ...
    def from_payload(cls, payload: Mapping[str, object]) -> Self:
        # Un estado compartido debe ser estricto para no aceptar corrupción silenciosa.
