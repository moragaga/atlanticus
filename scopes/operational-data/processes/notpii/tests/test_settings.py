...
from atlanticus.operational_data.processes.notpii.composition import NOTPII_JOB_DEFINITION
from atlanticus.operational_data.processes.notpii.errors import NotPiiProcessConfigurationError
from atlanticus.operational_data.processes.notpii.settings import (
    NotPiiSettings,
    configuration_specs,
)
...
def test_runtime_uses_robust_ten_minute_execution_and_lease_contract() -> None:
    ...
    assert NOTPII_JOB_DEFINITION.iteration_timeout_seconds == 580
