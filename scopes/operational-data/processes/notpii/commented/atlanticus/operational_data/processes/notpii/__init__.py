...
def build_catalog() -> Any:
    from atlanticus.operational_data.processes.notpii.catalog import build_catalog as _build_catalog

    return _build_catalog()


def build_composition(*, configuration: Any, catalog: Any = None) -> Any:
    from atlanticus.operational_data.processes.notpii.composition import (
...
def run(
    *,
    ...
    from atlanticus.operational_data.processes.notpii.bootstrap import run as _run
