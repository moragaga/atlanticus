# Espejo pedagógico del proceso Remanentes.
# Los tiempos 160/180 reflejan el runtime CURRENT, no los valores antiguos 580/600.
# La composición resuelve configuración y delega lectura, transformación y estado al producer.
...
from atlanticus.operational_data.processes.remanentes.catalog import build_catalog
from atlanticus.operational_data.processes.remanentes.settings import RemanentesSettings
...
REMANENTES_JOB_DEFINITION = JobDefinition(
    module_name='atlanticus.operational_data.processes.remanentes',
