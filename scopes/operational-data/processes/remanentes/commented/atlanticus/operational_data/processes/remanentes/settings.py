# Operational Data decide la conexión concreta de Remanentes.
# Aunque Storage soporta otras credenciales, este proceso conserva connection string como contrato operativo actual.
