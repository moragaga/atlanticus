...
from atlanticus.operational_data.processes.remanentes.composition import REMANENTES_JOB_DEFINITION
from atlanticus.operational_data.processes.remanentes.settings import (
    RemanentesSettings,
    configuration_specs,
)
