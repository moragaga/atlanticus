...
def test_process_is_owned_by_operational_data_workspace() -> None:
    ...
    assert project['project']['name'] == 'atlanticus-operational-data-remanentes-process'
    ...
    assert project['project']['scripts'] == {
        'operational-data-remanentes': 'atlanticus.operational_data.processes.remanentes.bootstrap:main'
    }
    assert project['tool']['atlanticus']['container']['command'] == 'operational-data-remanentes'
    assert 'tool' in workspace
    assert 'processes/remanentes' in workspace['tool']['uv']['workspace']['members']
    assert workspace['tool']['uv']['sources']['atlanticus-operational-data-remanentes-process'] == {
        'workspace': True
    }
