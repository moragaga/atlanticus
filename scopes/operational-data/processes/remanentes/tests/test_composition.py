...
from atlanticus.operational_data.processes.remanentes.composition import (
    REMANENTES_JOB_DEFINITION,
    build_composition,
)
...
def test_composition_passes_single_connection_and_identity(monkeypatch, tmp_path) -> None:
    import atlanticus.operational_data.processes.remanentes.composition as module
