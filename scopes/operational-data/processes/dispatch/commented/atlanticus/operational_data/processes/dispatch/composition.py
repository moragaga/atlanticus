...
from atlanticus.operational_data.processes.dispatch.scope import DispatchShiftScopeProvider
from atlanticus.operational_data.processes.dispatch.settings import DispatchSettings
...
DISPATCH_JOB_DEFINITION = JobDefinition(
    module_name='atlanticus.operational_data.processes.dispatch',
...
# La composición conserva sólo contexto Operational Data y una referencia al producer reutilizable.
