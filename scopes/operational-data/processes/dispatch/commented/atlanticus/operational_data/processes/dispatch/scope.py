# Adapta el calendario operacional Operational Data al SourceScope genérico usado por Data Producers.
from __future__ import annotations

from datetime import datetime

from atlanticus.data_producers.core import SourceScope, SourceScopeItem
from atlanticus.operational_data.calendar import get_shift_id_turn_window

_SHIFT_WINDOW_SIZE = 2


class DispatchShiftScopeProvider:
