...
from atlanticus.operational_data.processes.fabrica.composition import FABRICA_JOB_DEFINITION
from atlanticus.operational_data.processes.fabrica.settings import (
    FabricaSettings,
    configuration_specs,
)
