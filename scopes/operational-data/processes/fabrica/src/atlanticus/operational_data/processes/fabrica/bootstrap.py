...
from atlanticus.operational_data.processes.fabrica.composition import build_composition
from atlanticus.operational_data.processes.fabrica.errors import FabricaProcessConfigurationError
from atlanticus.operational_data.processes.fabrica.settings import configuration_specs
...
def _required_bootstrap_value(values: Mapping[str, str], key: str) -> str:
    ...
    if value != value.strip():
        raise FabricaProcessConfigurationError(f'{key} must not contain surrounding whitespace')
    return value
