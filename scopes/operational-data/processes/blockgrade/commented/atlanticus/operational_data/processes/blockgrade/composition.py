...
from atlanticus.operational_data.processes.blockgrade.scope import BlockgradeShiftScopeProvider
from atlanticus.operational_data.processes.blockgrade.settings import BlockgradeSettings
...
BLOCKGRADE_JOB_DEFINITION = JobDefinition(
    module_name='atlanticus.operational_data.processes.blockgrade',
