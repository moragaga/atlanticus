...
def build_catalog() -> tuple[Any, ...]:
    from atlanticus.operational_data.processes.blockgrade.catalog import (
...
def build_composition(*, configuration: Any, catalog: tuple[Any, ...] | None = None) -> Any:
    from atlanticus.operational_data.processes.blockgrade.composition import (
...
def run(
    *,
    ...
    from atlanticus.operational_data.processes.blockgrade.bootstrap import run as _run
