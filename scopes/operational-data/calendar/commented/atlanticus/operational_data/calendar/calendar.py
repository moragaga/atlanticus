...
# El calendario genérico concentra las reglas de día, semana y turnos; Mina y Planta sólo son configuraciones explícitas.
...
# Configuración inmutable de un calendario: las horas definen sus fronteras de dominio.
class OperationalCalendar:
    ...
    # El nombre de la fecha operacional corresponde al extremo de cierre de su ventana.
    ...
    # La noche cruza medianoche; el turno día permanece dentro de la fecha operacional.
    ...
    # La semana se ancla por weekday configurable y conserva la partición ISO del inicio.
