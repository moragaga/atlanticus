...
# El loader convierte tipos lógicos a Arrow sólo en esta capa física y vuelve a leer las fuentes en cada iteración.
# Las columnas de negocio son tolerantes; timestamp y shift se validan como estructura obligatoria.
...
from atlanticus.operational_data.planner import DataLoadPlan, DataSourceViewLoadPlan
