...
rem --clean se reserva para troubleshooting o verificacion desde cero.
set "CLEAN=0"
set "FORWARD_ARGS="
...
rem La sincronizacion instala packages locales de forma no editable y fuerza su reinstalacion.
