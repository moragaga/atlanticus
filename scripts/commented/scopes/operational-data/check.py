# Espejo pedagógico del gate de Operational Data.
# Valida foundation, producers y processes sin cambiar la lógica ejecutable.
# Los comentarios explican las fronteras; el AST productivo permanece idéntico.
...
# Registro único de capabilities del scope, incluyendo los seis composition roots.
...
# M-004D no permite mantener en paralelo los antiguos entrypoints bajo ada.processes.
...
# Esta verificación fuerza el move físico de los procesos; no crea aliases de compatibilidad.
