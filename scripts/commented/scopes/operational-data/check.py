# Espejo pedagógico del gate autoritativo de Operational Data.
# El gate valida foundation y producers como capabilities del mismo scope, sin convertirlos en backend transversal.
# Las fuentes locales se resuelven en un único workspace; los packages no declaran rutas propias.
