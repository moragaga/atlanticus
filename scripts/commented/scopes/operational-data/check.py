...
# El gate exige la misma versión de Python congelada para todo R3.6.
...
# Cada capability conserva distribución, import público y raíces para validar el mirror.
...
# Esta validación impide que el nuevo scope vuelva a depender del ownership histórico de ADA.
...
# Los wheels son la última comprobación de que sólo entra contenido productivo y tipado.
