...
`atlanticus-job-runtime==1.0.0` coordina ejecución, ventana temporal, lease, autoridad y cierre de jobs backend Atlanticus sin conocer conectores, datasets, State ni reglas de ADA.
