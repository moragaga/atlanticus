...
# Responsabilidad: NavigationManagerWorkspaceBinding encapsula una frontera explícita del contrato vigente.
class NavigationManagerWorkspaceBinding:
    ...
    # Operación: load_payload mantiene la misma semántica que el código productivo.
    def load_payload(
        self,
    ...
    # Operación: save_payload mantiene la misma semántica que el código productivo.
    def save_payload(
        self,
        document: dict[str, object] | None,
    ...
    # Operación: _require_workspace mantiene la misma semántica que el código productivo.
