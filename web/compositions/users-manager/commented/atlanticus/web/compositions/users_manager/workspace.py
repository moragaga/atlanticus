# Adapta únicamente las capabilities genéricas de workspace que Manager necesita para Users.
# La validación reconstruye el contrato canónico Users/Profiles; no usa UsersConfigurationCatalog.
# La lectura delega en load_current(), que ya garantiza payload y SourceSnapshot del mismo instante lógico.
