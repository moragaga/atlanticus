...
# El content hash depende solo del inventario ordenado; dos releases iguales pueden compartirlo.
...
# El cursor transporta una referencia lógica, nunca offsets ni rutas del filesystem.
