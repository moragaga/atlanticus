...
# La superficie comienza con un draft vacío; Manager reemplaza este estado desde su workspace al montar.
...
# Sólo los perfiles configurados participan en la paginación; los cuatro system profiles quedan fijos.
...
# La presentación renderiza únicamente filas reales de la página.
...
# Los perfiles del sistema son read-only. Local puede mostrar Jane/John entregados por composición.
...
# Las filas muestran sólo label y colores; la UUID queda encapsulada en el ID interno del botón.
...
# El modal no expone la key técnica. Create genera UUID4 y Update recibe la key desde EDITOR_STORE.
