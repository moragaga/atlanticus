...
# Contiene solo modelos de presentación y validación propios de Manager. El estado durable de Projection proviene del contrato genérico atlanticus.web.projection.
