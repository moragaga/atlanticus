...
# Modela el workspace del navegador sobre SourceSnapshot. La release detecta cambios funcionales y el token conserva la concurrencia optimista al publicar.
