...
def test_visual_normalization_layer_is_registered_after_home() -> None:
    ...
    assert entries.index('20_home.css') < entries.index('30_visual_normalization.css')
    assert entries.index('30_visual_normalization.css') < entries.index('40_interaction_surface.css')
