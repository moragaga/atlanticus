...
# La capa visual edita Profiles funcionales; Local y Pending no se presentan como perfiles configurables.
...
# Administrator permanece editable por el aggregate durable vigente, pero semánticamente es un Profile funcional.
...
# Esta tarjeta edita atributos visuales de un Profile funcional persistido por la configuración actual.
