# Registro Web productivo de Users admin.
# Este módulo selecciona canonical_callbacks como camino activo.
# callbacks.py legacy permanece físicamente hasta el milestone de legacy deletion.
