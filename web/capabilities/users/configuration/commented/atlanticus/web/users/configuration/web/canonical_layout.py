# Layout canónico de Users admin.
# CATALOG_STORE_ID contiene UsersProfilesConfiguration.
# DRAFT_BASIS_STORE_ID mantiene el draft schema 2 que preserva SourceSnapshot exacto.
