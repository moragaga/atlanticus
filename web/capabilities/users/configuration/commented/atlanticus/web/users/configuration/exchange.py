...
# El archivo de intercambio representa directamente UsersProfilesConfiguration; no emula una Source release.
...
# La lectura limita tanto el payload comprimido como el contenido descomprimido.
