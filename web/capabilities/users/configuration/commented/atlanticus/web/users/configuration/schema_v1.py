...
# Este decoder existe sólo para leer estado durable schema v1 y produce inmediatamente el aggregate CURRENT.
def decode_users_profiles_schema_v1(
    ...
    try:
        ...
        if not isinstance(raw_users, list) or not all(
            ...
            raise TypeError
        # Los colores guest se validan porque eran obligatorios en schema v1, pero no se materializan como perfil funcional.
