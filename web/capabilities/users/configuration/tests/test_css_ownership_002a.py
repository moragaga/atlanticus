...
SOURCE = ROOT / 'src/atlanticus/web/users/configuration'
CSS = SOURCE / 'resources/css'


def test_users_consumes_shared_controls_without_manager_css_contract() -> None:
    python = '\n'.join(
    ...
    assert 'atlanticus-ui-icon-button' in python
...
def test_users_modal_does_not_restyle_shared_select() -> None:
