# Define la autoridad Root de bootstrap como una estrategia de acceso de Identity.
# Root se identifica por issuer + subject_id exactos y no se materializa como User ni como Profile.
# Si la política está deshabilitada o no coincide, la identidad continúa por el resolver normal.
